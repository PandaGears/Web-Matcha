            ...
            function(err, result) {
                ...
                if (result.length > 0) {
                    ...
                    conn.query(sql, function(err, result) {
                        ...
                        (username, Email, userImage, Password, FirstName, LastName, userOrientation, userGender, Likes, userVerified, accountComplete, userAge, userDislikes, popularity, userBiography, userLocationlat, userLocationlng, lastOnline, userCode) VALUES
                        ...
                        DB.query(`INSERT INTO users
                        (username, Email, userImage, Password, FirstName, LastName, userOrientation, userGender, Likes, userVerified, accountComplete, userAge, userDislikes, popularity, userBiography, userLocationlat, userLocationlng, lastOnline, userCode) VALUES
                        ("02","ZeroTwo@Gmail.com", "https://res.cloudinary.com/ddrrwygt1/image/upload/v1591263131/002_ktwt2k.jpg", "$2b$10$bMG3yMTNIzvWzNC8zgiwkOOjGYjB0hVbBW5ec0F00z.mtR.r/Up8m", "Zero", "Two", 'pan', 'Female', 16, 1, 1, 24, 1, 15, "Whatever you do in life give 100%.....unless you're giving blood", -33.917, 18.3875, '2020-01-03 04:20', 'a2ef406e2c2351e0b9e80029c909242d')`);
                        DB.query(`INSERT INTO users
                        (username, Email, userImage, Password, FirstName, LastName, userOrientation, userGender, Likes, userVerified, accountComplete, userAge, userDislikes, popularity, userBiography, userLocationlat, userLocationlng, lastOnline, userCode) VALUES
